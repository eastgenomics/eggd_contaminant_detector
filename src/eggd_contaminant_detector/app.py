...
def sompy(truth: DXFileID, query: DXFileID, reference: DXFileID, ref_index: Optional[DXFileID]=None) -> SompyJobOutput:
...
def aggregate(sompy_files: list[DXLink]) -> SompyResults[DXFile]:
    ...
    agg_sompy_data = aggregate.read_csvs(input_path, pattern = "**/*.stats.csv")
