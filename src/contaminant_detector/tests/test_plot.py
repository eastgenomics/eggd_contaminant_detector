...
def test_shorten() -> None:
    ...
    assert plot.shorten(epic_name) == epic_name_shortened
    assert plot.shorten(non_epic_name) == non_epic_name
...
def test_get_sample_name_truth(sompy_snv_df: pd.DataFrame) -> None:
    ...
    actual_truth = plot.get_sample_name(sompycmd, "truth")
...
def test_get_sample_name_query(sompy_snv_df: pd.DataFrame) -> None:
    ...
    actual_query = plot.get_sample_name(sompycmd, "query")
